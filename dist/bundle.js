...
var BaseComponent = (function (_React$Component) {
  ...
  _createClass(BaseComponent, [{
    ...
    /** help bind react methods
    * @example this._bind('_handleClick', '_handleFoo');
    *
    */
...
BaseComponent.propTypes = { resource: _react2.default.PropTypes.string };
...
var Form = _react2.default.createClass({
  render: function render() {
    return _react2.default.createElement(
      'form',
      _extends({}, this.props, { className: this.props.className + ' rb-form' }),
      this.props.children
    );
  }
});
...
exports.Message = exports.Tooltip = exports.Resource = exports.Label = exports.Form = exports.Textbox = exports.ReactiveBanana = undefined;

var _reactivebanana = require('./reactivebanana');

var _reactivebanana2 = _interopRequireDefault(_reactivebanana);
...
exports.ReactiveBanana = _reactivebanana2.default;
...
},{"./form":160,"./label":163,"./message":164,"./reactivebanana":165,"./resource":166,"./textbox":167,"./tooltip":168}],162:[function(require,module,exports){
'use strict';
...
var Ajax = (function () {
  ...
  _createClass(Ajax, [{
    key: 'getJSON',
    value: function getJSON(url, data, success) {
...
var Resources = (function () {
  function Resources() {
    ...
    // TODO: take from application consts
    this.systemName = '';
  }

  _createClass(Resources, [{
    key: 'get',
    value: function get(resKey) {
      var resSubKey = arguments.length <= 1 || arguments[1] === undefined ? 'Text' : arguments[1];
      var _ref = arguments[2];
      var systemName = _ref.systemName;
      var callback = arguments[3];

      var _systemName = this.systemName || systemName;

      // TODO: call api endpoint
      var url = '';
      var requestData = { systemName: _systemName };
      var reqX = new Ajax();
      reqX.getJSON(url, requestData, function (responseData) {
      ...
      // TODO: return real resource

      return resKey + '.' + resSubKey;
    }
  }]);
...
var Label = (function (_Base) {
  ...
  _createClass(Label, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'label',
        _extends({}, this.props, { className: 'rb-label' }),
        this.props.text
      );
    }
  }]);
...
},{"./base":159,"./resource":166,"react":158}],164:[function(require,module,exports){
'use strict';
...
var Message = _react2.default.createClass({
  render: function render() {
    return _react2.default.createElement(
      'span',
      _extends({}, this.props, { className: 'rb-message' }),
      this.props.text
    );
  }
});
...
},{"./resource":166,"react":158}],165:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createClass({
  ...
  render: function render() {
    return _react2.default.createElement(
      _form2.default,
      { className: 'reactivebanana' },
      _react2.default.createElement(
        'h1',
        null,
        _react2.default.createElement(_resource2.default, { resKey: 'HelloWorld' })
      ),
      _react2.default.createElement(_textbox2.default, { type: 'text', value: 'cool', text: 'nice', onChange: this.handleChange })
    );
  }
});
},{"./form":160,"./label":163,"./message":164,"./resource":166,"./textbox":167,"./tooltip":168,"react":158}],166:[function(require,module,exports){
'use strict';
...
var _resources = require('./infra/resources');
...
var Resource = _react2.default.createClass({
  propTypes: {
    resKey: _react2.default.PropTypes.string.isRequired,
    resSubKey: _react2.default.PropTypes.string
  },
  render: function render() {
    var _props = this.props;
    var resKey = _props.resKey;
    var resSubKey = _props.resSubKey;

    var res = new _resources2.default();
    // TODO: get resource from infrajs
    var resVal = res.get(resKey, resSubKey, this.props);

    // TODO: only in debug mode use reskey
    return _react2.default.createElement(
      'span',
      null,
      resVal.text || this.props.resKey
    );
  }
});
// TODO: use form external package

exports.default = Resource;
},{"./infra/resources":162,"react":158}],167:[function(require,module,exports){
'use strict';
...
var Textbox = _react2.default.createClass({
  ...
  render: function render() {
    return _react2.default.createElement(
      'div',
      { className: 'rb-form-control' },
      _react2.default.createElement(_label2.default, this.props),
      _react2.default.createElement('input', _extends({}, this.props, { className: 'rb-textbox', ref: 'input', key: 'input' })),
...
},{"./label":163,"./message":164,"react":158}],168:[function(require,module,exports){
'use strict';
...
var Tooltip = _react2.default.createClass({
  render: function render() {
    return _react2.default.createElement('span', _extends({}, this.props, { title: this.props.title, className: 'rb-tooltip' }));
  }
});

exports.default = Tooltip;
},{"./resource":166,"react":158}],169:[function(require,module,exports){
"use strict";
...
var App = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(TitleStatus, null),
            React.createElement(FormDescriptionRow, null),
            React.createElement(FormHeader, null),
            React.createElement(FormSubHeader, null)
        );
    }
});
...
var TitleDescription = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            "div",
            null,
            React.createElement(PyUI.Resource, { resKey: "titleDescription" })
        );
    }
});

var TitleStatus = React.createClass({
    displayName: "TitleStatus",
    render: function render() {
        return React.createElement(
            "div",
            null,
            React.createElement(TitleStatusText, null),
            React.createElement(TitleStatusValue, null)
        );
    }
});

var TitleStatusText = React.createClass({
    displayName: "TitleStatusText",
    render: function render() {
        return React.createElement(
            "div",
            null,
            React.createElement(PyUI.Resource, { resKey: "titleStatusText" })
        );
    }
});

var TitleStatusValue = React.createClass({
    displayName: "TitleStatusValue",
    render: function render() {
        return React.createElement(
            "div",
            null,
            React.createElement(Status, { resKey: "statusText" })
        );
    }
});
...
var Status = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            "div",
            null,
            React.createElement(PyUI.Resource, { resKey: resKeyStatus })
        );
    }
});
...
var FormDescriptionRow = React.createClass({
    displayName: "FormDescriptionRow",
    render: function render() {
        return React.createElement(
            "div",
            null,
            React.createElement(PyUI.Resource, { resKey: "formDescriptionRow" })
        );
    }
});
...
var FormHeader = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            "div",
            null,
            React.createElement(PyUI.Resource, { resKey: "formHeader" })
        );
    }
});
...
},{"react":158,"react-dom":2,"reactivebanana":161}]},{},[169]);
